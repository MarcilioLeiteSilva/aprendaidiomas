    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Text(
            "Pratique conversação livre em alemão com nossa inteligência artificial inteligente.",
            style: TextStyle(color: AppTheme.textSecondaryColor, fontSize: 16),
          ),
          const SizedBox(height: 24),
          ListView.separated(
    ...
    return Container(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          final germanText = parts[0];
          final portugueseText = parts.length > 1 ? parts[1] : '';

          final isToggled = _showHintTranslationIndices.contains(index);
          final textToShow = isToggled && portugueseText.isNotEmpty ? portugueseText : germanText;
          ...
          return Container(
            ...
            child: Row(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    _textController.text = germanText;
                    _scrollToBottom();
                  },
                  child: Text(
                    textToShow,
            ...
            child: Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: _isRecording ? '$_tutorName está ouvindo...' : 'Digite em alemão...',
