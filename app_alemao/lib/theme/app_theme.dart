...
class AppTheme {
  ...
  static const Color accentColor = Color(0xFFD59F0F); // Dourado Real / Âmbar da bandeira alemã
      ...
      gradient: LinearGradient(
        ...
        colors: isDark 
          ? const [
              ...
              Color(0xFF111827), // Charcoal/Preto
              Color(0xFF332005), // Dourado Escuro sutil
            ]
          : const [
              Color(0xFFF8FAFC), // Slate 50
              Color(0xFFE5E7EB), // Gray 200
              Color(0xFFFEF3C7), // Amber 100 sutil
            ],
