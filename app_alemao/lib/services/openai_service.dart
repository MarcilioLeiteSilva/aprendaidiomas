  ...
  static Future<AiResponse> getConversationResponse({
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return AiResponse(
          english: data['target_text'] ?? '', // Texto em alemão é salvo no campo legado 'english'
      ...
      try {
        ...
        return const AiResponse(
          english: 'Oops! Ich hatte ein Verbindungsproblem. Kannst du das wiederholen?',
          portuguese: 'Ops, tive um problema de conexão. Pode repetir?',
          nextHints: [
            'Okay, ich wiederhole es.|Tudo bem, eu repito.',
            'Kein Problem.|Sem problemas.',
            'Versuchen wir es noch einmal!|Vamos tentar de novo!'
          ],
        );
      }
    }
