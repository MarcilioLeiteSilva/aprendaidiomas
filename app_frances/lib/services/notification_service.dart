...
class NotificationService {
  ...
  static Future<void> scheduleDailyStreakReminder() async {
    final prefs = await SharedPreferences.getInstance();
    final enabled = prefs.getBool(_preferenceKey) ?? true;
    if (!enabled) return;
    ...
    final title = streak > 0 ? "🔥 Ne perdez pas votre série de $streak jours !" : "📚 C'est l'heure de pratiquer le Français !";
    const body = "Complétez une leçon aujourd'hui pour maintenir votre série active et ne pas perdre votre progression !";
