...
class UserService {
  ...
  static Future<void> initialize() async {
    ...
    // Carrega ou gera o UUID do dispositivo
    _deviceUuid = prefs.getString(_uuidKey) ?? '';
    if (_deviceUuid.isEmpty) {
      _deviceUuid = _generateUuid();
  ...
  // Gera um UUIDv4 de forma determinística pura sem pacotes externos
