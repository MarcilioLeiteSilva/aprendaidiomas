...
class OpenAiService {
  static Future<AiResponse> getConversationResponse({
    ...
    String tutorName = 'Charlotte',
    String? selectedLevel,
  }) async {
    try {
      final isMale = tutorName == 'John' || tutorName == 'Daniel' || tutorName == 'Oliver' || tutorName == 'James' || tutorName == 'Arthur' || tutorName == 'Harry' || tutorName == 'Lucas' || tutorName == 'Hugo' || tutorName == 'Thomas' || tutorName == 'Louis' || tutorName == 'Nathan' || tutorName == 'Ben' || tutorName == 'Jonas' || tutorName == 'Leon' || tutorName == 'Finn' || tutorName == 'Noah' || tutorName == 'Mateo' || tutorName == 'Santiago' || tutorName == 'Matias' || tutorName == 'Sebastian' || tutorName == 'Diego' || tutorName == 'Alejandro' || tutorName == 'Luis';
      ...
      try {
        ...
        return const AiResponse(
          french: 'Oups, j\'ai eu un problème de connexion. Peux-tu répéter ?',
          portuguese: 'Ops, tive um problema de conexão. Pode repetir?',
          nextHints: [
            'D\'accord, je répète.|Tudo bem, eu repito.',
            'Pas de problème.|Sem problemas.',
            'On réessaie !|Vamos tentar de novo!'
          ],
        );
      }
    }
