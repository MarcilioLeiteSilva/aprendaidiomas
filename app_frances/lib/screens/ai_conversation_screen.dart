...
class _AiConversationScreenState extends State<AiConversationScreen> {
  ...
  void _sendMessage(String text) {
    ...
    // Call OpenAI API for dynamic conversation
    OpenAiService.getConversationResponse(
      ...
      _speak(response.french, isBot: true);
      _scrollToBottom();
    }).catchError((err) {
      if (!mounted) return;
      setState(() {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Text(
            "Pratique conversação livre em francês com nossa inteligência artificial inteligente.",
            style: TextStyle(color: AppTheme.textSecondaryColor, fontSize: 16),
          ),
          const SizedBox(height: 24),
          ListView.separated(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () => _speak(msg['french'] ?? '', isBot: isBot),
                  child: Icon(
                ...
                const SizedBox(width: 16),
                GestureDetector(
                  onTap: () => _showGrammarExplanation(msg['french'] ?? ''),
                  child: Icon(
    ...
    return Container(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          final frenchText = parts[0];
          final portugueseText = parts.length > 1 ? parts[1] : '';

          final isToggled = _showHintTranslationIndices.contains(index);
          final textToShow = isToggled && portugueseText.isNotEmpty ? portugueseText : frenchText;
          ...
          return Container(
            ...
            child: Row(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    _textController.text = frenchText;
                    _scrollToBottom();
                  },
                  child: Text(
                    textToShow,
            ...
            child: Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: _isRecording ? '$_tutorName está ouvindo...' : 'Digite em francês...',
...
class CharlottePulseAvatar extends StatefulWidget {
  ...
  @override
  State<CharlottePulseAvatar> createState() => _CharlottePulseAvatarState();
}

class _CharlottePulseAvatarState extends State<CharlottePulseAvatar> with SingleTickerProviderStateMixin {
