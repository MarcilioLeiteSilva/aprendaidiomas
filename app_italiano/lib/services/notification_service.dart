...
class NotificationService {
  ...
  static Future<void> scheduleDailyStreakReminder() async {
    ...
    final title = streak > 0 ? "🔥 Não perca seu streak de $streak dias!" : "📚 Hora de praticar Italiano!";
    const body = "Complete uma lição hoje para manter sua ofensiva ativa e não perder seu progresso!";
