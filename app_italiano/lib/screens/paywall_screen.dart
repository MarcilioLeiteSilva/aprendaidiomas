...
class _PaywallScreenState extends State<PaywallScreen> {
  ...
  void initState() {
    super.initState();
    // Listen for premium status changes triggered by BillingService
    UserService.currentUserNotifier.addListener(_onPremiumStatusChanged);
  }

  @override
  void dispose() {
    UserService.currentUserNotifier.removeListener(_onPremiumStatusChanged);
    super.dispose();
  }
  ...
  void _handlePurchase() async {
    ...
    try {
      ...
      // Result arrives via purchaseStream -> _onPremiumStatusChanged
    } catch (e) {
      if (!mounted) return;
      setState(() {
        _isPurchasing = false;
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  'Você agora é Premium! Desfrute de conversas com italiano ilimitado, vozes ultra-realistas e tutor de gramática em todos os temas.',
                ...
                ElevatedButton(
                  onPressed: () {
                    ...
                    Navigator.pop(context); // Close PaywallScreen
                  },
                  ...
                  sliver: SliverList(
                    delegate: SliverChildListDelegate([
                      _buildBenefitItem(
                        ...
                        description: 'Pratique italiano sem restrições diárias ou necessidade de assistir anúncios.',
                      ),
