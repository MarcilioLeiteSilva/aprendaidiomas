    ...
    try {
      ...
      try {
        ...
        return const AiResponse(
          english: 'Oops! I had a connection problem. Can you repeat that?',
          portuguese: 'Ops, tive um problema de conexão. Pode repetir?',
          nextHints: [
            'Okay, I will repeat it.|Tudo bem, eu repito.',
            'No problem.|Sem problemas.',
            "Let's try again!|Vamos tentar de novo!"
          ],
        );
      }
    }
