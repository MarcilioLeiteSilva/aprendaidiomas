...
class _AiConversationScreenState extends State<AiConversationScreen> {
  ...
  void _sendMessage(String text) {
    ...
    OpenAiService.getConversationResponse(
      ...
      _speak(response.english, isBot: true);
      _scrollToBottom();
    }).catchError((err) {
      if (!mounted) return;
      setState(() {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Text(
            "Pratique conversação livre em inglês com nossa inteligência artificial inteligente.",
            style: TextStyle(color: AppTheme.textSecondaryColor, fontSize: 16),
          ),
          const SizedBox(height: 24),
          ListView.separated(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () => _speak(msg['english'] ?? '', isBot: isBot),
                  child: Icon(
                ...
                const SizedBox(width: 16),
                GestureDetector(
                  onTap: () => _showGrammarExplanation(msg['english'] ?? ''),
                  child: Icon(
    ...
    return Container(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          final englishText = parts[0];
          final portugueseText = parts.length > 1 ? parts[1] : '';

          final isToggled = _showHintTranslationIndices.contains(index);
          final textToShow = isToggled && portugueseText.isNotEmpty ? portugueseText : englishText;
          ...
          return Container(
            ...
            child: Row(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    _textController.text = englishText;
                    _scrollToBottom();
                  },
                  child: Text(
                    textToShow,
            ...
            child: Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: _isRecording ? '$_tutorName está ouvindo...' : 'Digite em inglês...',
