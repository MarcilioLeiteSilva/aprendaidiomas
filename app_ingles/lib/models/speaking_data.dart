...
final List<SpeakingScenario> speakingScenarios = [
  ...
  const SpeakingScenario(
    ...
    messages: [
      ...
      SpeakingMessage(en: "Oh man, you are a lifesaver! I owe you big time for this, seriously.", pt: "Cara, você salvou minha vida! Fico te devendo essa, sério.", isBot: true),
  ...
  const SpeakingScenario(
    ...
    messages: [
      ...
      SpeakingMessage(en: "Yeah, we did! It was a bit pricey, but the food was out of this world.", pt: "Sim, nós fomos! Foi um pouco caro, mas a comida estava de outro mundo.", isBot: false),
  ...
  const SpeakingScenario(
    ...
    messages: [
      ...
      SpeakingMessage(en: "Right? I did not see that coming at all! It kept me on the edge of my seat.", pt: "Né? Eu não esperava por aquilo de jeito nenhum! Me deixou preso à cadeira.", isBot: true),
